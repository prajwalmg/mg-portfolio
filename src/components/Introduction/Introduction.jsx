  ...
  return (
    <div className="intro">
      ...
      <div className="nameContainer">
        <Parallax style={{ transform: `translateX(calc(-10vh + ${offset * 0.2}px)` }}>
      ...
      <div className="jobTitleContainer">
        <Parallax
          style={{ transform: `translateX(calc(70vh + ${-offset * 0.3}px))` }}
        >
      ...
      <div className="jobTitleContainer">
        <Parallax
          style={{ transform: `translateX(calc(-90vh + ${offset * 0.3}px))` }}
        >
